    ...
    <div class="wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                ...
                                <form action="{{ route('/artikel-berita/store') }}" method="POST"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kategori[]" multiple="multiple" style="width: 100%"
                                            ...
                                            <textarea name="konten"
                                                class="my-editor form-control 
                                                    @error('konten')
                                                        is-invalid
                                                    @enderror"
                                                value="{{ old('konten') }}" id="my-editor" cols="50" rows="10"></textarea>
                                            @error('konten')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
        ...
        <script type="text/javascript">
            ...
            $('#judul_artikel').on('blur', function(e) {
                $.get('{{ url('/artikel-berita/store/check-slug') }}', {
                        'title': $(this).val()
                    },
                    function(data) {
                        $('#slug').val(data.slug);
